...
function f6RunReport_() {
  ...
  if (trades7d.length === 0 && tradesY.length === 0 && tradesM.length === 0) {
    ...
    f6ReportToMeta_('F-Index', '7日間', 0, '-', '-', 0, 0, '取引なし');
    f6ReportToMeta_('F-Index', '前日', 0, '-', '-', 0, 0, '取引なし');
    f6ReportToMeta_('F-Index', rangeM.label, 0, '-', '-', 0, 0, '取引なし');
    return;
  }
  ...
  f6WritePeriodSheet_(F6_SHEET_DAILY, '【F-Index 前日レポート】', tradesY, statsY);
  f6WritePeriodSheet_(F6_SHEET_MONTHLY, '【F-Index 月次レポート】', tradesM, statsM);
